...
public class WebSecurityConfig {
    ...
    public CorsFilter corsFilter() { //프로튼 앤드와 소통을 하기 위해서 만들어진 것
     ...
     * - 비동기 통신을 하는 Rest API의 경우 사용자가 의도치 않게 악의적인 요청을 보내는 CSRF 공격보호를 비활성화
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(
                                ...
                                //토큰이 없어도 접근할 수있는 사이트 -홈화면(모임), 모임 상세페이지, 고객 센터, 로그인/회원가입 페이지
    ...
    @Bean
    // 인증 관리자 관련 설정
    //: 사용자가 입력한 자격증명(아이디,비밀번호)이 올바른지 확인
    //
